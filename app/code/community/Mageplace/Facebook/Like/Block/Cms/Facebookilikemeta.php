...
class Mageplace_Facebook_Like_Block_Cms_Facebookilikemeta extends Mageplace_Facebook_Like_Block_Abstract
{
	/**
	 * Constructor
	 */
	public function __construct()
	{
		...
		$this->setTemplate('facebookilike/cms/facebookilikemeta.phtml');
	}
