...
class Mageplace_Facebook_Like_Block_Catalog_Product_Facebookilikemeta extends Mageplace_Facebook_Like_Block_Abstract
{
	/**
	 * Constructor
	 */
	public function __construct()
	{
		...
		$this->setTemplate('facebookilike/catalog/product/facebookilikemeta.phtml');
	}
